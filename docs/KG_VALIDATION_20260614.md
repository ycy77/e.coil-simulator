...
- RegulonDB sign distribution: {'-': 3617, '+': 3370, '-+': 344, '?': 20, '6)function': 1}
- Unmappable regulators (sigma factors, sRNAs, small-molecule effectors like ppGpp, complexes): 14 distinct, covering 362 interactions.
  Top unmapped: ppgpp(308), rcsb-bglj(16), carbon storage regulator csra(14), hipab(5), dan(4), dinj-yafq(3), atp-dependent rna helicase dead(3), selb-l-selenocysteinyl-trna<sup>sec</sup>(2), small heat shock protein ibpa(2), 2)regulatorname(1), h-+ns(1), threonine&mdash;trna ligase(1), ribonuclease e(1), istr-1(1)
