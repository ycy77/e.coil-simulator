...
- `encodes` <-- [[gene.b1404|gene.b1404]] `UniProt|EcoCyc` `database` - EcoCyc gene PRODUCT

## External IDs

- `UniProt:P0CF89`
- `KEGG:ecj:JW1401;eco:b1404;eco:b4284;ecoc:C3026_23100;`
- `GeneID:93673411;948815;`
