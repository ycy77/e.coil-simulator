---
entity_id: "molecule.ecocyc.NAD-P-OR-NOP"
entity_type: "small_molecule"
name: "NAD(P)+"
source_database: "EcoCyc"
source_id: "NAD-P-OR-NOP"
default_state: "low"
...
`molecule.ecocyc.NAD-P-OR-NOP`

## Static

- Type: `small_molecule`
- Source: `EcoCyc:NAD-P-OR-NOP`
- Default state: `low`
...
Consumed as substrate in 22 reaction(s). Produced in 14 reaction(s).
...
- `is_product_of` --> [[reaction.ecocyc.FAD-RED-RXN|reaction.ecocyc.FAD-RED-RXN]] `EcoCyc` `database` - EcoCyc reaction RIGHT
- `is_product_of` --> [[reaction.ecocyc.FMN-RED-RXN|reaction.ecocyc.FMN-RED-RXN]] `EcoCyc` `database` - EcoCyc reaction RIGHT
- `is_product_of` --> [[reaction.ecocyc.NQOR-RXN|reaction.ecocyc.NQOR-RXN]] `EcoCyc` `database` - EcoCyc reaction RIGHT
- `is_product_of` --> [[reaction.ecocyc.R621-RXN|reaction.ecocyc.R621-RXN]] `EcoCyc` `database` - EcoCyc reaction RIGHT
- `is_product_of` --> [[reaction.ecocyc.RXN-10745|reaction.ecocyc.RXN-10745]] `EcoCyc` `database` - EcoCyc reaction RIGHT
- `is_product_of` --> [[reaction.ecocyc.RXN-10745-1|reaction.ecocyc.RXN-10745-1]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_product_of` --> [[reaction.ecocyc.RXN0-7386|reaction.ecocyc.RXN0-7386]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_substrate_of` --> [[reaction.ecocyc.1.1.1.264-RXN|reaction.ecocyc.1.1.1.264-RXN]] `EcoCyc` `database` - EcoCyc reaction LEFT
- `is_substrate_of` --> [[reaction.ecocyc.1.5.1.20-RXN|reaction.ecocyc.1.5.1.20-RXN]] `EcoCyc` `database` - EcoCyc reaction LEFT
...
- `is_substrate_of` --> [[reaction.ecocyc.GLYC3PDEHYDROGBIOSYN-RXN|reaction.ecocyc.GLYC3PDEHYDROGBIOSYN-RXN]] `EcoCyc` `database` - EcoCyc reaction LEFT
...
- `is_substrate_of` --> [[reaction.ecocyc.QUINATE-5-DEHYDROGENASE-RXN|reaction.ecocyc.QUINATE-5-DEHYDROGENASE-RXN]] `EcoCyc` `database` - EcoCyc reaction LEFT
...
- `is_substrate_of` --> [[reaction.ecocyc.RXN-12445|reaction.ecocyc.RXN-12445]] `EcoCyc` `database` - EcoCyc reaction LEFT
...
- `is_substrate_of` --> [[reaction.ecocyc.RXN-14641|reaction.ecocyc.RXN-14641]] `EcoCyc` `database` - EcoCyc reaction LEFT
...
- `is_substrate_of` --> [[reaction.ecocyc.RXN-7632|reaction.ecocyc.RXN-7632]] `EcoCyc` `database` - EcoCyc reaction LEFT
