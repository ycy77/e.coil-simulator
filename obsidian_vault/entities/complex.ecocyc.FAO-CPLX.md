---
entity_id: "complex.ecocyc.FAO-CPLX"
entity_type: "complex"
name: "trifunctional fatty acid oxidation complex"
...
aliases:
  - "EcTFE"
  - "aerobic trifunctional enzyme"
---

# trifunctional fatty acid oxidation complex

`complex.ecocyc.FAO-CPLX`

## Static

- Type: `complex`
- Source: `EcoCyc:FAO-CPLX`
- Default state: `active`
- Allowed states: `active|impaired|disrupted|assembled|disassembled|inhibited`
- Complex type: `structural`
- Components: [[protein.P21177|protein.P21177]], [[protein.P21151|protein.P21151]]
...
- `is_component_of` <-- [[protein.P21151|protein.P21151]] `EcoCyc` `database` - EcoCyc component coefficient=2 | EcoCyc protcplxs.col coefficient=2
- `is_component_of` <-- [[protein.P21177|protein.P21177]] `EcoCyc` `database` - EcoCyc component coefficient=2 | EcoCyc protcplxs.col coefficient=2

## External IDs

- `EcoCyc:FAO-CPLX`
- `QSPROTEOME:QS00171719`

## Notes

2*protein.P21177|2*protein.P21151
