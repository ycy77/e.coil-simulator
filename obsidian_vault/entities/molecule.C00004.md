...
KEGG compound: NADH; DPNH; Reduced nicotinamide adenine dinucleotide
...
- `activates` --> [[reaction.ecocyc.UGD-RXN|reaction.ecocyc.UGD-RXN]] `EcoCyc` `database` - EcoCyc regulation TYPES=Regulation-of-Enzyme-Activity
...
- `is_product_of` --> [[reaction.R10267|reaction.R10267]] `KEGG` `database` - C00008 + C04856 <=> C00020 + C00009 + C00004
...
- `is_product_of` --> [[reaction.ecocyc.1.1.1.39-RXN|reaction.ecocyc.1.1.1.39-RXN]] `EcoCyc` `database` - EcoCyc reaction RIGHT
- `is_product_of` --> [[reaction.ecocyc.1.1.1.83-RXN|reaction.ecocyc.1.1.1.83-RXN]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_product_of` --> [[reaction.ecocyc.FERREDOXIN--NAD_-REDUCTASE-RXN|reaction.ecocyc.FERREDOXIN--NAD_-REDUCTASE-RXN]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_product_of` --> [[reaction.ecocyc.RXN-13158|reaction.ecocyc.RXN-13158]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_product_of` --> [[reaction.ecocyc.RXN-22001|reaction.ecocyc.RXN-22001]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_product_of` --> [[reaction.ecocyc.RXN0-1861|reaction.ecocyc.RXN0-1861]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_product_of` --> [[reaction.ecocyc.RXN0-307|reaction.ecocyc.RXN0-307]] `EcoCyc` `database` - EcoCyc reaction RIGHT
- `is_product_of` --> [[reaction.ecocyc.RXN0-5229|reaction.ecocyc.RXN0-5229]] `EcoCyc` `database` - EcoCyc reaction RIGHT
- `is_product_of` --> [[reaction.ecocyc.RXN0-5248|reaction.ecocyc.RXN0-5248]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_substrate_of` --> [[reaction.ecocyc.RXN0-6450|reaction.ecocyc.RXN0-6450]] `EcoCyc` `database` - EcoCyc reaction LEFT
...
- `represses` --> [[reaction.ecocyc.DIENOYLCOAREDUCT-RXN|reaction.ecocyc.DIENOYLCOAREDUCT-RXN]] `EcoCyc` `database` - EcoCyc regulation TYPES=Regulation-of-Enzyme-Activity
...
- `represses` --> [[reaction.ecocyc.NAD-KIN-RXN|reaction.ecocyc.NAD-KIN-RXN]] `EcoCyc` `database` - EcoCyc regulation TYPES=Regulation-of-Enzyme-Activity
- `represses` --> [[reaction.ecocyc.PFLDEACTIV-RXN|reaction.ecocyc.PFLDEACTIV-RXN]] `EcoCyc` `database` - EcoCyc regulation TYPES=Regulation-of-Enzyme-Activity
...
- `represses` --> [[reaction.ecocyc.RXN-7716|reaction.ecocyc.RXN-7716]] `EcoCyc` `database` - EcoCyc regulation TYPES=Regulation-of-Enzyme-Activity
- `represses` --> [[reaction.ecocyc.RXN0-1132|reaction.ecocyc.RXN0-1132]] `EcoCyc` `database` - EcoCyc regulation TYPES=Regulation-of-Enzyme-Activity
