...
KEGG compound: NADPH; TPNH; Reduced nicotinamide adenine dinucleotide phosphate
...
- `activates` --> [[reaction.ecocyc.RXN-16819|reaction.ecocyc.RXN-16819]] `EcoCyc` `database` - EcoCyc regulation TYPES=Regulation-of-Enzyme-Activity
- `binds` --> [[complex.ecocyc.DXPREDISOM-CPLX|complex.ecocyc.DXPREDISOM-CPLX]] `EcoCyc` `database` - EcoCyc enzymatic reaction cofactor
...
- `is_product_of` --> [[reaction.R10268|reaction.R10268]] `KEGG` `database` - C00008 + C04899 <=> C00020 + C00009 + C00005
...
- `is_product_of` --> [[reaction.ecocyc.MALIC-NADP-RXN|reaction.ecocyc.MALIC-NADP-RXN]] `EcoCyc` `database` - EcoCyc reaction RIGHT
- `is_product_of` --> [[reaction.ecocyc.METHYLENETHFDEHYDROG-NADP-RXN|reaction.ecocyc.METHYLENETHFDEHYDROG-NADP-RXN]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_product_of` --> [[reaction.ecocyc.RXN-17897|reaction.ecocyc.RXN-17897]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_product_of` --> [[reaction.ecocyc.RXN-20767|reaction.ecocyc.RXN-20767]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_product_of` --> [[reaction.ecocyc.RXN-924|reaction.ecocyc.RXN-924]] `EcoCyc` `database` - EcoCyc reaction RIGHT
...
- `is_substrate_of` --> [[reaction.ecocyc.RXN-16765|reaction.ecocyc.RXN-16765]] `EcoCyc` `database` - EcoCyc reaction LEFT
...
- `represses` --> [[reaction.ecocyc.DEPHOSICITDEHASE-RXN|reaction.ecocyc.DEPHOSICITDEHASE-RXN]] `EcoCyc` `database` - EcoCyc regulation TYPES=Regulation-of-Enzyme-Activity
- `represses` --> [[reaction.ecocyc.GLU6PDEHYDROG-RXN|reaction.ecocyc.GLU6PDEHYDROG-RXN]] `EcoCyc` `database` - EcoCyc regulation TYPES=Regulation-of-Enzyme-Activity
