...
- `is_component_of` --> [[complex.ecocyc.CPLX0-3930|complex.ecocyc.CPLX0-3930]] `EcoCyc` `database` - EcoCyc component coefficient=4 | EcoCyc protcplxs.col coefficient=4

## Incoming Edges (1)

- `encodes` <-- [[gene.b1892|gene.b1892]] `UniProt|EcoCyc` `database` - EcoCyc gene PRODUCT

## External IDs

- `UniProt:P0A8S9`
- `KEGG:ecj:JW1881;eco:b1892;ecoc:C3026_10755;`
- `GeneID:93776197;945442;`
- `GO:GO:0003677; GO:0005667; GO:0005737; GO:0006351; GO:0044780; GO:0045893; GO:1902210`
