---
entity_id: "reaction.ecocyc.RXN0-21"
...
`reaction.ecocyc.RXN0-21`

## Static

- Type: `reaction`
- Source: `EcoCyc:RXN0-21`
...
Catalyzed by heme ABC transporter CydDC (complex.ecocyc.ABC-6-CPLX). Substrates: H2O (molecule.C00001), ATP (molecule.C00002), Glutathione (molecule.C00051). Products: ADP (molecule.C00008), Glutathione (molecule.C00051), H+ (molecule.C00080), phosphate (molecule.ecocyc.Pi).
