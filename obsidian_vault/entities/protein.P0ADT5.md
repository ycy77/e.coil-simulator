...
- `encodes` <-- [[gene.b3038|gene.b3038]] `UniProt|EcoCyc` `database` - EcoCyc gene PRODUCT

## External IDs

- `UniProt:P0ADT5`
- `KEGG:ecj:JW3006;eco:b3038;ecoc:C3026_16590;`
- `GeneID:75173163;947249;`
