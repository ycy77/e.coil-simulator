...
G10555 + G10557(n) di-trans,poly-cis-Undecaprenyl diphosphate + G10557(n+1)
...
- `is_product_of` <-- [[molecule.C04574|molecule.C04574]] `KEGG` `database` - G10555 + G10557(n) <=> C04574 + G10557(n+1)
...
EQUATION: G10555 + G10557(n) <=> C04574 + G10557(n+1)
