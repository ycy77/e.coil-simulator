---
entity_id: "reaction.ecocyc.RXN0-6370"
...
`reaction.ecocyc.RXN0-6370`

## Static

- Type: `reaction`
- Source: `EcoCyc:RXN0-6370`
- Default state: `active`
- Allowed states: `active|blocked`

## Enriched Summary

NITRATE + E- + PROTON -> NITRITE + WATER; direction=LEFT-TO-RIGHT EcoCyc reaction equation: NITRATE + E- + PROTON -> NITRITE + WATER; direction=LEFT-TO-RIGHT.
...
NITRATE + E- + PROTON -> NITRITE + WATER; direction=LEFT-TO-RIGHT
