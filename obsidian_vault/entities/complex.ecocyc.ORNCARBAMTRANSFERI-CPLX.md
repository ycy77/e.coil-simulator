---
entity_id: "complex.ecocyc.ORNCARBAMTRANSFERI-CPLX"
entity_type: "complex"
name: "ornithine carbamoyltransferase"
source_database: "EcoCyc"
source_id: "ORNCARBAMTRANSFERI-CPLX"
...
`complex.ecocyc.ORNCARBAMTRANSFERI-CPLX`

## Static

- Type: `complex`
- Source: `EcoCyc:ORNCARBAMTRANSFERI-CPLX`
- Default state: `active`
- Allowed states: `active|impaired|disrupted|assembled|disassembled|inhibited`
- Complex type: `structural`
- Components: [[protein.P04391|protein.P04391]]
...
- `is_component_of` <-- [[protein.P04391|protein.P04391]] `EcoCyc` `database` - EcoCyc component coefficient=3 | EcoCyc protcplxs.col coefficient=3

## External IDs

- `EcoCyc:ORNCARBAMTRANSFERI-CPLX`
- `QSPROTEOME:QS00176897`
