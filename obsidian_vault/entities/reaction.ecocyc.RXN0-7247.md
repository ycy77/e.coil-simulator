---
entity_id: "reaction.ecocyc.RXN0-7247"
...
`reaction.ecocyc.RXN0-7247`

## Static

- Type: `reaction`
- Source: `EcoCyc:RXN0-7247`
...
Aldehydes -> Aldehydes; direction=REVERSIBLE EcoCyc reaction equation: Aldehydes -> Aldehydes; direction=REVERSIBLE.

## Biological Role

Catalyzed by outer membrane porin PhoE (complex.ecocyc.CPLX0-7530), outer membrane porin C (complex.ecocyc.CPLX0-7533), outer membrane porin F (complex.ecocyc.CPLX0-7534). Substrates: Aldehyde (molecule.C00071). Products: Aldehyde (molecule.C00071).

## Annotation

Aldehydes -> Aldehydes; direction=REVERSIBLE
